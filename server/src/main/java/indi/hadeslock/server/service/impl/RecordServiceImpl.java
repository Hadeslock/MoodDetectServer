...
public class RecordServiceImpl extends ServiceImpl<RecordMapper, Record> implements IRecordService {
    ...
    public int saveRecords(HashMap<String, String> dataMap, List<Record> list) {
        ...
        double latitude = Double.parseDouble(dataMap.get("latitude"));
        double longitude = Double.parseDouble(dataMap.get("longitude"));
        //根据deviceMac查出设备信息
        ...
        DetectionRecord detectionRecord =
                new DetectionRecord(device.getId(), patientId, date, startTime, endTime, keyTime, latitude, longitude);
